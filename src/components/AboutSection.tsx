...
function Feature({
  ...
  return <motion.div className="flex flex-col p-6 bg-white rounded-xl shadow-sm border border-dental-blue/10 h-full" initial={{
    opacity: 0,
    y: 20
  }} whileInView={{
    opacity: 1,
...
export function AboutSection() {
  ...
  return <section id="about" className="w-full py-16 md:py-24 bg-dental-mint/30">
      <div className="container mx-auto px-4">
        ...
        <motion.div className="mt-16 relative rounded-2xl overflow-hidden shadow-xl" initial={{
        opacity: 0,
        y: 30
      }} whileInView={{
        opacity: 1,
