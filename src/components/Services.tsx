  ...
  const services: Service[] = [
    {
      ...
      image: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=1000",
      icon: (
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1616598935074-33b146e93e9d?q=80&w=1000",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-dental-accent">
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1581585375722-ac173d1778c0?q=80&w=1000",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-dental-accent">
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1581585791550-94fa1f0974b8?q=80&w=1000",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-dental-accent">
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1588345921523-c2dcdb7f1dcd?q=80&w=1000",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-dental-accent">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="service-card h-64 md:h-72"
              ...
              viewport={{ once: true }}
            >
              <div className="absolute inset-0 p-6 flex flex-col items-center justify-center bg-gradient-to-b from-transparent via-transparent to-black/30">
